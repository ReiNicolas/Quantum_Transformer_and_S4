##All bellow this line was writen by Albert Gu, Karan Goel and Christopher Ré and copy pasted from https://github.com/state-spaces/s4/blob/main/models/s4/s4.py, all credits are given to them for this file and the S4 model.
